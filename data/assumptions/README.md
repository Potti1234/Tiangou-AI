...
Line, cable, transformer, and demand-profile values are intentionally conservative synthetic engineering defaults anchored to public Hong Kong voltage classes, OSM topology tags, and public sector consumption totals. They should be replaced by observed public project ratings, equipment data, or feeder-level hourly demand data when such data is available.
