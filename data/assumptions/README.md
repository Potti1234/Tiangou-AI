...
Line, cable, transformer, demand-profile, and data-center values are intentionally conservative synthetic engineering defaults anchored to public Hong Kong voltage classes, OSM topology tags, and public sector consumption totals. They should be replaced by observed public project ratings, equipment data, feeder-level hourly demand data, or operator-published data-center capacity evidence when such data is available.
